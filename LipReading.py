...
#    
#    def attention(hidden,outsEncoder):# вообще бред скорее всего
...
##
Y_answer=Variable(torch.torch.randn(seq_len,1,36)) # верные Y
decoder= DecoderRNN()
Y_NN = decoder(Y_answer,hidden) #Y_NN - что выдала NN
#
##%% 